...
if [[ -z "$ENVIRONMENT" ]]; then
  ...
  echo "  1. Initialize the machine (install containerd, tools including yq)" >&2
  echo "  2. Render policy from ../k8s-bastion-policy for the specified environment" >&2
  echo "  3. Configure users, groups, and policies" >&2
  exit 1
fi
...
echo "==============================================="
echo "Bastion Initialization"
echo "Environment: $ENVIRONMENT"
echo "==============================================="
echo ""

echo "Step 1/3: Initializing machine (containerd, tools including yq)"
...
echo ""
echo "Step 3/3: Configuring users, groups, and policies"
users_args=(--init --source "$SCRIPT_DIR")
